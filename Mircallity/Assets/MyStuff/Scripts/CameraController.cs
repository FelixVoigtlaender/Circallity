...
public class CameraController : MonoBehaviour {
    ...
    void LateUpdate()
    {
        ...
        if (!lockSize)
        {
            float oSize = Mathf.SmoothDamp(Camera.main.orthographicSize, newSize, ref smoothVelocitySize, sizeSmoothTime);
    ...
    public void SetObjects(GameObject[] objects)
    {
        ...
        newSize = ToOrthographicSize(FindMax(middle, points.ToArray()));
